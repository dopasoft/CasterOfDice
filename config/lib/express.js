...
var config = require('../config'),
  ...
  _ = require('lodash'),
  lusca = require('lusca'),
  webpackConfig = process.env.NODE_ENV === 'production' ? require('../webpack.config/webpack.prod.conf') : require('../webpack.config/webpack.dev.conf');
...
module.exports.initViewEngine = function (app) {
  ...
  compiler.hooks.afterEmit.tap('html-webpack-plugin-after-emit', function (compilation) {
